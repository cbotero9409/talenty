...
user5 = User.create!(email: "andres1@gmail.com", password: "A#123456", first_name: "Felipe", last_name: "Espinoza")
user6 = User.create!(email: "andres2@gmail.com", password: "A#123456", first_name: "Andres", last_name: "Escobar")
user7 = User.create!(email: "andres3@gmail.com", password: "A#123456", first_name: "karla", last_name: "Gomez")
user8 = User.create!(email: "andres4@gmail.com", password: "A#123456", first_name: "Patricia", last_name: "Jimenez")
user9 = User.create!(email: "andres5@gmail.com", password: "A#123456", first_name: "Laura", last_name: "bedoya")
user10 = User.create!(email: "andres6@gmail.com", password: "A#123456", first_name: "Carlos", last_name: "palomo")
user11 = User.create!(email: "andres7@gmail.com", password: "A#123456", first_name: "Boris", last_name: "cabal")
user12 = User.create!(email: "andres8@gmail.com", password: "A#123456", first_name: "Hector", last_name: "Figueroa")
user13 = User.create!(email: "andres9@gmail.com", password: "A#123456", first_name: "Camila", last_name: "Galvis")
user14 = User.create!(email: "andres10@gmail.com", password: "A#123456", first_name: "Mauricio", last_name: "Restrepo")
user15 = User.create!(email: "andres11@gmail.com", password: "A#123456", first_name: "Diego", last_name: "Solari")
user16 = User.create!(email: "andres12@gmail.com", password: "A#123456", first_name: "Camilo", last_name: "Calderon")
user17 = User.create!(email: "andres13@gmail.com", password: "A#123456", first_name: "Valentina", last_name: "Ochoa")
user18 = User.create!(email: "andres14@gmail.com", password: "A#123456", first_name: "Silvia", last_name: "Ramirez")
user19 = User.create!(email: "andres15@gmail.com", password: "A#123456", first_name: "Yeison", last_name: "Cardenas")
user20 = User.create!(email: "andres16@gmail.com", password: "A#123456", first_name: "Gustavo", last_name: "Cabello")
...
user3.save
user4.photo.attach(io: URI.open('https://www.littler.com/files/reales_maria-camila_30135.png'), filename: "2.png", content_type: "image/png")
user4.save
...
user6.save
user7.photo.attach(io: URI.open('https://img.freepik.com/fotos-premium/trabajadoras-usan-mascarillas-desechables-proteccion-corona-virus-spread-filtro-contaminacion-aire-polvo-humo-fabrica-cuidado-laboral-saludable_43300-1903.jpg?w=2000'), filename: "2.png", content_type: "image/png")
user7.save
