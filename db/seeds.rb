...
service1 = Service.create!(name: "Reparacion cableado", duration: 30, price: 30_000, user: user1, category: category1)
service2 = Service.create!(name: "Instalacion breaker", duration: 60, price: 20_000, user: user1, category: category1)
service3 = Service.create!(name: "Reparacion de armarios", duration: 120, price: 70_000, user: user2, category: category5)
service4 = Service.create!(name: "Arreglo cajones de la cocina", duration: 180, price: 50_000, user: user2, category: category5)
service5 = Service.create!(name: "Podar el cesped", duration: 240, price: 90_000, user: user3, category: category3)
service6 = Service.create!(name: "Limpieza de la casa", duration: 360, price: 60_000, user: user3, category: category4)
