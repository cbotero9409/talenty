...
user5 = User.create!(email: "andres1@gmail.com", password: "A#123456", first_name: "Felipe", last_name: "Espinoza", address: "Calle 30 #70-31")
user6 = User.create!(email: "andres2@gmail.com", password: "A#123456", first_name: "Andres", last_name: "Escobar", address: "Calle 31 #71-32")
user7 = User.create!(email: "andres3@gmail.com", password: "A#123456", first_name: "karla", last_name: "Gomez", address: "Calle 32 #72-33")
user8 = User.create!(email: "andres4@gmail.com", password: "A#123456", first_name: "Patricia", last_name: "Jimenez", address: "Calle 33 #73-34")
user9 = User.create!(email: "andres5@gmail.com", password: "A#123456", first_name: "Laura", last_name: "bedoya", address: "Calle 34 #74-35")
user10 = User.create!(email: "andres6@gmail.com", password: "A#123456", first_name: "Carlos", last_name: "palomo", address: "Calle 35 #75-35")
user11 = User.create!(email: "andres7@gmail.com", password: "A#123456", first_name: "Boris", last_name: "cabal", address: "Calle 36 #76-37")
user12 = User.create!(email: "andres8@gmail.com", password: "A#123456", first_name: "Hector", last_name: "Figueroa", address: "Calle 37 #77-38")
user13 = User.create!(email: "andres9@gmail.com", password: "A#123456", first_name: "Camila", last_name: "Galvis", address: "Calle 38 #78-39")
user14 = User.create!(email: "andres10@gmail.com", password: "A#123456", first_name: "Mauricio", last_name: "Restrepo", address: "Calle 39 #79-40")
user15 = User.create!(email: "andres11@gmail.com", password: "A#123456", first_name: "Diego", last_name: "Solari", address: "Calle 40 #80-41")
user16 = User.create!(email: "andres12@gmail.com", password: "A#123456", first_name: "Camilo", last_name: "Calderon", address: "Calle 41 #81-42")
user17 = User.create!(email: "andres13@gmail.com", password: "A#123456", first_name: "Valentina", last_name: "Ochoa", address: "Calle 42 #82-43")
user18 = User.create!(email: "andres14@gmail.com", password: "A#123456", first_name: "Silvia", last_name: "Ramirez", address: "Calle 43 #83-44")
user19 = User.create!(email: "andres15@gmail.com", password: "A#123456", first_name: "Yeison", last_name: "Cardenas", address: "Calle 44 #84-45")
user20 = User.create!(email: "andres16@gmail.com", password: "A#123456", first_name: "Gustavo", last_name: "Cabello", address: "Calle 45 #85-46")
